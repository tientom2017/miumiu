...
class Facebook_Like_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'facebook_like', 'description' => __('Thêm like fanpage','genesis'));
		$control_ops = array('id_base' => 'facebook-like-widget');
		$this->WP_Widget('facebook-like-widget', __('RT - Fanpage Like Box','mythemeshop'), $widget_ops, $control_ops);
	}
